...
def release(t):
    ...
    os.chdir("/Users/ly/work/pep/cdPEP")
    os.system("git pull")
    os.system("pwd")
    p=subprocess.Popen("""grep -rs "tag" fe/szidc-prod.yaml | awk '{print $3}'""", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
    oldTag=p.stdout.readlines()[0][0:-1].decode()
    alter("fe/szidc-prod.yaml",oldTag,tag)

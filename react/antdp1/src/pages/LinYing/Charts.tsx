...
const getAnnotationConfgs = (annotation: MesAPI.AggLineAnnotation) => {
  const configs = {
    point: {
      type: 'dataMarker',
      position: [
        (annotation as MesAPI.DataMarkerAnnotation).x,
        (annotation as MesAPI.DataMarkerAnnotation).y,
      ],
      text: {
    ...
    vertical_line: {
      type: 'line',
      start: [(annotation as MesAPI.VerticalLineAnnotation).x, 'min'],
      end: [(annotation as MesAPI.VerticalLineAnnotation).x, 'max'],
      text: {
        content: annotation.label,
        position: 'right',
    ...
    horizontal_line: {
      type: 'line',
      start: ['min', (annotation as MesAPI.HorizontalLineAnnotation).y],
      end: ['max', (annotation as MesAPI.HorizontalLineAnnotation).y],
      text: {
        content: annotation.label,
        position: 'right',
        style: { textAlign: 'right' },
...
export const PieChart: React.FC<{ chart: MesAPI.AggPieChart }> = ({ chart }) => {
...
export const DividerChart: React.FC<{ chart: MesAPI.AggDividerChart }> = ({ chart }) => {
  return <Divider orientation={chart.orientation}>{chart.title}</Divider> 
};

export const BarChart: React.FC<{ chart: MesAPI.AggBarChart,options:{isHorizontal:boolean} ,isMerged:boolean}> = ({ chart,options,isMerged }) => {
...
export const MmtImage: React.FC<{ tableResult: MesAPI.AggImageResult} > 
= ({ tableResult }) => {
  return <div>
...
export const AntBox: React.FC<{result:MesAPI.AggBoxChart }> = ({result}) => {
  return (
...
export const CompareChart:React.FC<{result:{results:MesAPI.AggResult[]}}> = ({result}) => {
